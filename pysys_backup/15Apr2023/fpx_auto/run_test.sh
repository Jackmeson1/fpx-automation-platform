...
#Local
WSL=1 # if your are running this bash from your windows WSL
...
#RUN=/path/to/the/PySystem/command/file
RUN=/Project/PySystem/sysrunner/run.py
#SCENARIO=/Project/FPX/TestCases/7.0.0/FortiProxy/Policy-Matching/test.csv
SCENARIO=/Path/to/your/TestTask/scenario/csv/file
#TC_BASE=/Project/FPX/TestCases/7.0.0
TC_BASE=/path/to/your/Testcase/base/folder/ # Where the root dir name "FortiProxy" locates  
#CONF=/Project/fpx_auto/lab_env/leo_lab.json
CONF=/path/to/your/lab/config/json/file

SKIP_FIXTURE=0 # set to 1 if you want to skip the Fixture/config (fixture.prov file) steps that has "skip_fixture" in the folder
#FAIL_ACTION="stop"
FAIL_ACTION="continue" # continue running or stop when a TC fails
LOG_LEVEL=
DEBUG=0
VERBOSE=1
