    ...
    def login(self):
        ...
        for i in range(2):
            ...
            try:
                ...
                self.wait_for_visible(v, by, timeout=10)
                self.logged_in = True
                break
            except:
                continue
...
class FpxGui(FosGui):
    def __init__(self, ip='localhost',
                 ...
                 timeout=GuiNode.DEFAULT_TIMEOUT,
                 labels={}):
        super().__init__(ip, port, user, passwd, conn_type, browser_type, accept_untrusted_cert, timeout, labels)
