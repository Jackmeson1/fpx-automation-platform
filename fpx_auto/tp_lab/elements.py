...
Linux111 = cli_node.UbuntuCli(
    ...
    labels={
        ...
        'VIP_SERVER': '10.150.0.161',
        'IP_MGMT': '10.150.0.111',
        #'VIP_MGMT': '10.150.0.161',
...
Linux110.VIP_SERVER = '10.150.0.160'
Linux110.IP_MGMT = '10.150.0.110'
#Linux110.VIP_MGMT = '10.150.0.160'
...
Linux109 = cli_node.UbuntuCli( # TP_client
    ...
    labels={
            ...
            'IF_INET': 'ens160',
            'IP_INET': '172.18.29.109',
            'DEFAULT_GATEWAY': '172.18.29.1',
            'TP_GATEWAY': '10.150.0.4',
...
Fpx_69 = ftnt_cli.FpxCli(
    ...
    labels={'IF_CLIENT': 'port6',
            ...
            'IF_MGMT': 'port1',
            'IP_MGMT': '10.1.1.69',
            'IP_CLIENT': '10.150.0.69',
            'PROXY_PORT': '8080',
            'TP_POOL_IP1': '10.150.0.70',
            'TP_POOL_IP2': '10.150.0.71',
            'IF_DEFAULT_ROUTE': 'port1',
            'DEFAULT_GATEWAY': '10.150.0.4',
