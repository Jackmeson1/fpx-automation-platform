...
#SCENARIO=/Project/FPX/TestTasks/7.0.10/FortiProxy-7.0.10-Sanity-Policy-Matching.csv
SCENARIO=/Project/fpx_auto/tp_pol_7.4.csv
TC_BASE=/Project/FPX/TestCases/7.4
CONF=/Project/fpx_auto/tp_lab/leo_tplab.json
