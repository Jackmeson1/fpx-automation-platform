...
def main():
    examples = (
        "Examples:\n"
        "  python rename_tc.py orig.csv gen.csv\n"
        "  python rename_tc.py orig.csv gen.csv --mv\n"
        "\u793a\u4f8b:\n"
        "  python rename_tc.py \u539f\u59cb.csv \u7cfb\u7edf\u751f\u6210.csv --mv"
    )
    parser = argparse.ArgumentParser(
        description='rename TC script files based on QAID generated by Oriole',
    ...
    parser.add_argument('-mv', '--mv', action='store_true', default=False,
                        help='do not keep the original script files (move instead of copy)')
