...
#SCENARIO=/Project/FPX/TestCases/7.2.0/FortiProxy/Policy-Matching/test.csv
SCENARIO=/Project/FPX/TestCases/7.2.0/FortiProxy/Policy-Matching/policy-matching.csv
